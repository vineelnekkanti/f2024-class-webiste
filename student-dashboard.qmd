...
final_weekly_activity_table_gt <- final_weekly_activity_table |> 
  ...
  tab_header(
    title = md("**Weekly Coding Checkups Score**")
  ) |> 
  tab_footnote(
...
viewof tableSelector = Select(["Overall Learning Score", "Weekly Coding Checkups Score", "In-Class Participation", "Teams Participation", "Professionalism", "Others"], {label: "Choose a category:"})
...
html`<div id="table-container" style="overflow-x:auto; max-width: 100%;"></div>`
{
  ...
  return "Reach out to Dr. B or T.A for any queries regarding your scores.";
}
